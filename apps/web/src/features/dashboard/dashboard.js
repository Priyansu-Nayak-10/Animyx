...
export function initRecommendations({ store, libraryStore, selectors, toast = null }) {
  ...
  function buildRecommendationCard(anime) {
    ...
    return `<article class="reco-card tilt-card" data-id="${malId}">
